...
- **`anki-translate-deck` Workspace Skill:** A procedural workflow that automatically translates Anki note fields into English, handling normalization and batched processing via subagents.
